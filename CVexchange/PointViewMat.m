...
for i=1:num_im
    ...
    M(i,indx_largest_M+1:indx_largest_M+length_new)=current_matches_left;
        ...
        M(1,indx_largest_M+1:indx_largest_M+length(new_matches_left))=new_matches_left;
        M(i,indx_largest_M+1:indx_largest_M+length(new_matches_left))=current_matches_left;
    end
